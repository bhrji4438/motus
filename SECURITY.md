# Security Policy - Vectro Platform

We take the security of the Vectro platform and multi-tenant applications seriously. This document describes security configurations, isolation mechanisms, authentication practices, and instructions for reporting vulnerabilities.

---

## 1. Reporting a Vulnerability

If you discover a security vulnerability in the Vectro monorepo, please do **NOT** open a public issue. Instead, report the vulnerability to the maintainers:
...
Vectro enforces absolute data isolation between tenants to prevent cross-tenant information disclosure.
...
- WebSocket namespaces and rooms are prefixed with tenant-specific IDs: `tenant:{tenantId}:session:{sessionId}:tracking`.
...
When deploying Vectro in a production environment:
