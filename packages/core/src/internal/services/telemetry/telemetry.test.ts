...
import {
  encodePolyline,
  decodePolyline,
} from "@/internal/services/telemetry/polyline.js";
...
describe("Phase 4 Telemetry: TelemetryManager Metrics", () => {
  ...
  it("should enforce adaptive sampling thresholds", () => {
    ...
    const closePoint = {
      latitude: 12.97161,
      longitude: 77.59461,
      timestamp: "2026-06-11T12:00:05Z",
    };
    ...
    const delayedPoint = {
      latitude: 12.97161,
      longitude: 77.59461,
      timestamp: "2026-06-11T12:00:15Z",
    };
  ...
  it("should compute distance, duration, idle, and average speed", () => {
    const path = [
      ...
      },
      {
        latitude: 12.9725,
        longitude: 77.5955,
        timestamp: "2026-06-11T12:00:10Z",
        speed: 5.0,
      },
      {
        latitude: 12.973,
        longitude: 77.596,
        timestamp: "2026-06-11T12:00:20Z",
        speed: 0.2,
      },
    ];
  ...
  it("should handle empty or single point paths when calculating metrics", () => {
    ...
    const singleMetrics = manager.calculateMetrics([
      {
        latitude: 12.9716,
        longitude: 77.5946,
        timestamp: "2026-06-11T12:00:00Z",
