...
export { CorrelationContext, ICorrelationContext } from '@/logger/CorrelationContext.js';
...
export { DatabaseInstrumenter, DatabaseTelemetryOptions } from '@/instrumentation/database.js';
export { QueueInstrumenter, QueueTelemetryOptions } from '@/instrumentation/queue.js';
export { EventInstrumenter } from '@/instrumentation/events.js';
export { registerFastifyHooks, expressMiddleware } from '@/instrumentation/request.js';

// Health and Diagnostics exports
export { HealthCheckRegistry, defaultHealthRegistry, HealthStatus, HealthCheckResult, HealthCheckFn } from '@/diagnostics/HealthCheck.js';
