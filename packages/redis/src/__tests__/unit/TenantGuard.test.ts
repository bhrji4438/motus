...
describe('TenantGuard', () => {
  describe('validate', () => {
    ...
    it('throws for tenantId containing colon (key injection)', () => {
      expect(() => TenantGuard.validate('tnt:bad')).toThrow('invalid characters');
    });
  ...
  describe('validateDriverId', () => {
    ...
    it('throws for empty driverId', () => {
      expect(() => TenantGuard.validateDriverId('')).toThrow('non-empty string');
    });
  });
  ...
  describe('validateSessionId', () => {
    ...
    it('throws for empty sessionId', () => {
      expect(() => TenantGuard.validateSessionId('')).toThrow('non-empty string');
    });
  });
});
