...
async function main() {
  ...
  setInterval(() => {
    ...
    defaultDispatchMonitor.updateDriverLocation('T1', 'driver-1', { latitude: lat, longitude: lng });
    ...
    if (count % 5 === 0) {
      ...
      console.log(`[Demo API] Simulated live driver telemetry movement - Broadcast sent (${count})`);
    }
  }, 1000);
}
